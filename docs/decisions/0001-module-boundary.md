# ADR-001: Keep codec-compression as an Independent Gnalloy Module
...
`codec-compression` is published as `gnalloy.org/codec-compression` and owns this responsibility: Compression codecs for Gnalloy pipelines, including gzip, zlib, brotli, snappy, lz4, zstd, bzip2, lzma, FastLZ, and LZF.
